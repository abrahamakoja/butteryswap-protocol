...
error executeLoanRequestFailed();
 ...
 library LoanRequest {
    ...
    enum RequestState { OPEN, CANCELLED, CLOSED, CANCELLING }
    ...
    function createActiveLoan(address[3] memory _owners, uint256 _collateral,address memcoinAddress,uint256 _amoutToPayBack,address _borrower,address _lender) internal pure returns (ActiveLoan memory) {
    ...
    function createBorrowRequest(address[3] memory _owners, uint256 _collateral,address memcoinAddress) internal pure returns (BorrowRequest memory) {
    ...
    function withdrawBorrowRequestTokenBalance( 
    ...
    function createLendRequest(address[3] memory _owners, uint256 _amountLended) internal pure returns (LendRequest memory) {
        return LendRequest({
    ...
    function withdrawLendFunds(LendRequest storage request, address contractAddress, address recipient, uint256 amount) internal {
