...
**Buttery swap is a lending and borrowing protocol for erc-20 tokens, it uses a FIFO matching system ,ERC6909Upgradeable contracts for internal tokenization and a UUPS Proxy for loan request factory.**
